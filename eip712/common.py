...
from eth_pydantic_types.hex.bytes import HexBytes  # noqa: TC002
...
class SafeTxV1(EIP712Message):
    ...
    gasToken: abi.address = "0x0000000000000000000000000000000000000000"
    refundReceiver: abi.address = "0x0000000000000000000000000000000000000000"
    nonce: abi.uint256
...
def create_safe_tx_def(
    ...
    if major == 1 and minor < 3:
        ...
        SafeTx = create_model("SafeTx", __base__=SafeTxV2)
